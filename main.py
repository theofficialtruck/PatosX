...
class StaffSections(discord.ui.View):
    ...
    async def other(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed.add_field(name=f"{self.prefix}testwelcome #channel", value="Test welcome channel. PREFIX ONLY.", inline=False)
        embed.add_field(name=f"{self.prefix}testboost #channel", value="Test boost channel. PREFIX ONLY.", inline=False)
